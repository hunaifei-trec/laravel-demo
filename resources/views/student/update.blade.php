...
@section('content')
  ...
  <div class="panel panel-default">
      <div class="panel-heading col-sm-5">
        <h3 class="panel-title text-center">Update Student</h3>
      </div>
              ...
              <div class="form-group">
                  ...
                  <div class="col-sm-5">
                      <input type="text" name="Student[name]"
                              value="{{ !empty(old('Student')['name']) ? old('Student')['name'] : $student->name }}"
              ...
              <div class="form-group">
                  ...
                  <div class="col-sm-5">
                      <input type="text" name="Student[age]"
                              value="{{ !empty(old('Student')['age']) ?  old('Student')['age'] : $student->age }}"
